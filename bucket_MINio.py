...
def main():
    ...
    client.fput_object(
        "configdata", "storage/config.yaml", "/home/ubuntu/dev/webapp/webdemo/storage/config.yaml",
    )
    # Upload '/home/user/Photos/asiaphotos.zip' as object name
    # 'asiaphotos-2015.zip' to bucket 'asiatrip'.
    #Write weights of stable diffusion version 1 
    client.fput_object(
        "modelweight", "storage/model_weights/diff1/model_v1.ckpt", "/home/ubuntu/dev/webapp/webdemo/storage/model_weights/diff1/model_v1.ckpt",
    )
    print(
    ...
    # # Write weights of stable diffusion version 1 
    client.fput_object(
        "modelweight", "storage/model_weights/diff2/model_v2_768.ckpt", "/home/ubuntu/dev/webapp/webdemo/storage/model_weights/diff2/model_v2_768.ckpt",
    )
    print(
    ...
    client.fput_object(
        "modelweight", "storage/model_weights/diff2/512-inpainting-ema.ckpt", "/home/ubuntu/dev/webapp/webdemo/storage/model_weights/diff2/512-inpainting-ema.ckpt",
    )
    print(
    ...
    client.fput_object(
        "modelweight", "storage/model_weights/diff2/x4-upscaler-ema.ckpt", "/home/ubuntu/dev/webapp/webdemo/storage/model_weights/diff2/x4-upscaler-ema.ckpt",
    )
    print(
