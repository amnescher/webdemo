...
def inference(img_path,version = '1.3' ,upscale = 2,bg_upsampler= 'realesrgan',bg_tile = 400):
    ...
    model_path = os.path.join('/home/storage/model_weights/GFPGAN/', model_name + '.pth')
    ...
    output_path = os.path.join(args.output, str(uuid.uuid4()))
    ...
    if restored_img is not None:
        ...
        if args.suffix is not None:
            ...
            save_restore_path = os.path.join(output_path, f'{basename}_{args.suffix}.{extension}')
            
        else:
            save_restore_path = os.path.join(output_path, f'{basename}.{extension}')
            
        imwrite(restored_img, save_restore_path)
    return  output_path, save_restore_path
